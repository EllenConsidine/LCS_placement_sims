...
write.csv(Results[[1]], paste0("LCS_results/D366-All_PA_sites.csv"),
          row.names = FALSE)
write.csv(Results[[2]], paste0("LCS_results/D366-All_PA_sites_unweighted.csv"),
          row.names = FALSE)
...
#     print(i)
#   }
#   write.csv(W_Results, paste0("LCS_results/SA-D366-PA_N_",n,".csv"), 
#             row.names = FALSE)
#   W_avg_res<- apply(W_Results, MARGIN = 2, mean)
#   write.csv(W_avg_res, paste0("LCS_results/SA-D366-PA_N_",n,"_avg.csv"),
#             row.names = FALSE)
          
#   write.csv(UNW_Results, paste0("LCS_results/SA-D366-PA_N_",n,"_unweighted.csv"), 
#             row.names = FALSE)
#   UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
#   write.csv(UNW_avg_res, paste0("LCS_results/SA-D366-PA_N_",n,"_unweighted_avg.csv"),
#             row.names = FALSE)
# }
...
#     print(i)
#   }
#   write.csv(W_Results, paste0("LCS_results/SA-D366-School_N_",n,".csv"), 
#             row.names = FALSE)
#   W_avg_res<- apply(W_Results, MARGIN = 2, mean)
#   write.csv(W_avg_res, paste0("LCS_results/SA-D366-School_N_",n,"_avg.csv"),
#             row.names = FALSE)
          
#   write.csv(UNW_Results, paste0("LCS_results/SA-D366-School_N_",n,"_unweighted.csv"), 
#             row.names = FALSE)
#   UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
#   write.csv(UNW_avg_res, paste0("LCS_results/SA-D366-School_N_",n,"_unweighted_avg.csv"),
#             row.names = FALSE)
# }
...
#     print(i)
#   }
#   write.csv(W_Results, paste0("LCS_results/SA-D366-Roads_N_",n,".csv"), 
#             row.names = FALSE)
#   W_avg_res<- apply(W_Results, MARGIN = 2, mean)
#   write.csv(W_avg_res, paste0("LCS_results/SA-D366-Roads_N_",n,"_avg.csv"),
#             row.names = FALSE)
          
#   write.csv(UNW_Results, paste0("LCS_results/SA-D366-Roads_N_",n,"_unweighted.csv"), 
#             row.names = FALSE)
#   UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
#   write.csv(UNW_avg_res, paste0("LCS_results/SA-D366-Roads_N_",n,"_unweighted_avg.csv"),
#             row.names = FALSE)
# }
...
#     print(i)
#   }
#   write.csv(W_Results, paste0("LCS_results/SA-D366-CES_pollution_N_",n,".csv"), 
#             row.names = FALSE)
#   W_avg_res<- apply(W_Results, MARGIN = 2, mean)
#   write.csv(W_avg_res, paste0("LCS_results/SA-D366-CES_pollution_N_",n,"_avg.csv"),
#             row.names = FALSE)
          
#   write.csv(UNW_Results, paste0("LCS_results/SA-D366-CES_pollution_N_",n,"_unweighted.csv"), 
#             row.names = FALSE)
#   UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
#   write.csv(UNW_avg_res, paste0("LCS_results/SA-D366-CES_pollution_N_",n,"_unweighted_avg.csv"),
#             row.names = FALSE)
# }
...
#     print(i)
#   }
#   write.csv(W_Results, paste0("LCS_results/SA-D366-CES_score_N_",n,".csv"), 
#             row.names = FALSE)
#   W_avg_res<- apply(W_Results, MARGIN = 2, mean)
#   write.csv(W_avg_res, paste0("LCS_results/SA-D366-CES_score_N_",n,"_avg.csv"),
#             row.names = FALSE)
          
#   write.csv(UNW_Results, paste0("LCS_results/SA-D366-CES_score_N_",n,"_unweighted.csv"), 
#             row.names = FALSE)
#   UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
#   write.csv(UNW_avg_res, paste0("LCS_results/SA-D366-CES_score_N_",n,"_unweighted_avg.csv"),
#             row.names = FALSE)
# }
