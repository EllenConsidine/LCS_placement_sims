...
# write.csv(Results[[1]], paste0("LCS_results/D366-AQS_sites_msclf.csv"),
#           row.names = FALSE)
# write.csv(Results[[2]], paste0("LCS_results/D366-AQS_sites_unweighted_msclf.csv"),
#           row.names = FALSE)
...
for(n in c(50, 100, 250, 500, 1000)){
  ...
  write.csv(W_Results, paste0("LCS_results/D366-School_N_",n,"_msclf.csv"), 
            row.names = FALSE)
  W_avg_res<- apply(W_Results, MARGIN = 2, mean)
  write.csv(W_avg_res, paste0("LCS_results/D366-School_N_",n,"_avg_msclf.csv"),
            row.names = FALSE)
          
  write.csv(UNW_Results, paste0("LCS_results/D366-School_N_",n,"_unweighted_msclf.csv"), 
            row.names = FALSE)
  UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
  write.csv(UNW_avg_res, paste0("LCS_results/D366-School_N_",n,"_unweighted_avg_msclf.csv"),
            row.names = FALSE)
}
...
for(n in c(50, 100, 250, 500, 1000)){
  ...
  write.csv(W_Results, paste0("LCS_results/D366-Roads_N_",n,"_msclf.csv"), 
            row.names = FALSE)
  W_avg_res<- apply(W_Results, MARGIN = 2, mean)
  write.csv(W_avg_res, paste0("LCS_results/D366-Roads_N_",n,"_avg_msclf.csv"),
            row.names = FALSE)
          
  write.csv(UNW_Results, paste0("LCS_results/D366-Roads_N_",n,"_unweighted_msclf.csv"), 
            row.names = FALSE)
  UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
  write.csv(UNW_avg_res, paste0("LCS_results/D366-Roads_N_",n,"_unweighted_avg_msclf.csv"),
            row.names = FALSE)
}
...
for(n in c(50, 100, 250, 500, 1000)){
  ...
  write.csv(W_Results, paste0("LCS_results/D366-CES_pollution_N_",n,"_msclf.csv"), 
            row.names = FALSE)
  W_avg_res<- apply(W_Results, MARGIN = 2, mean)
  write.csv(W_avg_res, paste0("LCS_results/D366-CES_pollution_N_",n,"_avg_msclf.csv"),
            row.names = FALSE)
          
  write.csv(UNW_Results, paste0("LCS_results/D366-CES_pollution_N_",n,"_unweighted_msclf.csv"), 
            row.names = FALSE)
  UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
  write.csv(UNW_avg_res, paste0("LCS_results/D366-CES_pollution_N_",n,"_unweighted_avg_msclf.csv"),
            row.names = FALSE)
}
...
for(n in c(50, 100, 250, 500, 1000)){ 
  ...
  write.csv(W_Results, paste0("LCS_results/D366-CES_score_N_",n,"_msclf.csv"), 
            row.names = FALSE)
  W_avg_res<- apply(W_Results, MARGIN = 2, mean)
  write.csv(W_avg_res, paste0("LCS_results/D366-CES_score_N_",n,"_avg_msclf.csv"),
            row.names = FALSE)
          
  write.csv(UNW_Results, paste0("LCS_results/D366-CES_score_N_",n,"_unweighted_msclf.csv"), 
            row.names = FALSE)
  UNW_avg_res<- apply(UNW_Results, MARGIN = 2, mean)
  write.csv(UNW_avg_res, paste0("LCS_results/D366-CES_score_N_",n,"_unweighted_avg_msclf.csv"),
            row.names = FALSE)
}
